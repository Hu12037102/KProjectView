...
dependencies {
   ...
   <declare-styleable name="ItemView">
        <!--Item左标题LeftMargin-->
        <attr name="title_left_margin" format="dimension"/>
        <!--Item左标题TopMargin-->
        <attr name="title_top_margin" format="dimension"/>
        <!--Item左标题RightMargin-->
        <attr name="title_right_margin" format="dimension"/>
        <!--Item左标题BottomMargin-->
        <attr name="title_bottom_margin" format="dimension"/>
        <!--Item左标题Left图标-->
        ...
        <!--Item左标题LeftPadding-->
        <attr name="title_left_padding" format="dimension" />
        <!--Item左标题TopPadding-->
        <attr name="title_top_padding" format="dimension" />
        <!--Item左标题RightPadding-->
        <attr name="title_right_padding" format="dimension" />
        <!--Item左标题BottomPadding-->
        <attr name="title_bottom_padding" format="dimension" />
        <!--Item左标题大小-->
        ...
        <!--Item左标题LeftPadding-->
        <attr name="content_left_padding" format="dimension" />
        <!--Item左标题TopPadding-->
        <attr name="content_top_padding" format="dimension" />
        <!--Item左标题RightPadding-->
        <attr name="content_right_padding" format="dimension" />
        <!--Item左标题BottomPadding-->
        <attr name="content_bottom_padding" format="dimension" />
        <!--Item右标题下线-->
        <attr name="show_bottom_line" format="boolean" />
        <!--Item右标题标下线颜色-->
        <attr name="bottom_line_color" format="color|reference" />
        <!--Item左标题LeftMargin-->
        <attr name="content_left_margin" format="dimension"/>
        <!--Item左标题TopMargin-->
        <attr name="content_top_margin" format="dimension"/>
        <!--Item左标题RightMargin-->
        <attr name="content_right_margin" format="dimension"/>
        <!--Item左标题BottomMargin-->
        <attr name="content_bottom_margin" format="dimension"/>
        <!--Item选择器样式-->
